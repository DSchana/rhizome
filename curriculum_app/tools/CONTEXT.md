...
- **curricula.py** — `create_curriculum`, `get_curriculum`, `list_curricula`, `update_curriculum`, `delete_curriculum`. Standard CRUD; delete cascades to topics and entries via ORM.
