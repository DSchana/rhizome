"""FlashcardViewer — read-only widget for browsing flashcards."""
...
# Color constants (matching EntryViewer palette)
...
class FlashcardViewer(Widget, can_focus=True):
    ...
    FlashcardViewer #fv-list-scroll {
        height: auto;
        max-height: 10;
        margin: 1 0 1 0;
    }
    FlashcardViewer #fv-list {
        height: auto;
    }
    FlashcardViewer #fv-detail-panel {
        border: solid $surface-lighten-2;
        padding: 1 2;
        height: auto;
    }
    FlashcardViewer #fv-question-label {
        text-style: bold;
        color: rgb(100,100,100);
        margin-bottom: 0;
    }
    FlashcardViewer #fv-question {
        margin: 0 0 1 0;
    }
    FlashcardViewer #fv-answer-label {
        text-style: bold;
        color: rgb(100,100,100);
        margin-bottom: 0;
    }
    FlashcardViewer #fv-answer-scroll {
        height: auto;
        max-height: 10;
    }
    FlashcardViewer #fv-answer {
        height: auto;
    }
    FlashcardViewer #fv-meta {
        color: rgb(100,100,100);
        margin: 1 0 0 0;
    }
    FlashcardViewer #fv-notes-label {
        text-style: bold;
        color: rgb(100,100,100);
        margin: 1 0 0 0;
    }
    FlashcardViewer #fv-notes {
        height: auto;
        margin: 0;
    }
    FlashcardViewer #fv-empty {
        color: $text-muted;
        text-style: italic;
        margin: 1 0 0 1;
    }
