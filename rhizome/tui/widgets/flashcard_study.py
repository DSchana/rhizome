"""FlashcardStudy — interactive flashcard review widget with spaced-repetition rating."""
...
class FlashcardStudy(Widget, can_focus=True):
    ...
    FlashcardStudy #fs-header {
        height: 1;
        margin: 0 0 1 0;
    }
    FlashcardStudy #fs-card {
        border: solid rgb(80,80,120);
        padding: 1 2;
        height: auto;
        margin: 0 4;
    }
    FlashcardStudy #fs-question-label {
        text-style: bold;
        color: rgb(100,100,100);
        margin-bottom: 0;
    }
    FlashcardStudy #fs-question {
        margin: 0 0 1 0;
        color: rgb(200,200,220);
    }
    FlashcardStudy #fs-separator {
        height: 1;
        margin: 0 0 1 0;
        color: rgb(80,80,120);
    }
    FlashcardStudy #fs-answer-label {
        text-style: bold;
        color: rgb(100,100,100);
        margin-bottom: 0;
    }
    FlashcardStudy #fs-answer {
        margin: 0;
        color: rgb(180,220,180);
    }
    FlashcardStudy #fs-reveal-hint {
        color: rgb(80,80,80);
        text-align: center;
        margin: 1 0 0 0;
    }
    FlashcardStudy #fs-ratings {
        height: auto;
        text-align: center;
        margin: 1 0 0 0;
    }
    FlashcardStudy #fs-scored-label {
        text-align: center;
        margin: 1 0 0 0;
    }
    FlashcardStudy #fs-empty {
        color: $text-muted;
        text-style: italic;
        margin: 1 0 0 1;
    }
    FlashcardStudy #fs-done {
